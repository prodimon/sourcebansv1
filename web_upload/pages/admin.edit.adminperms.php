...
{
	$log = new CSystemLog("w", "Ошибка доступа", $userbank->GetProperty("user") . " пытался отредактировать разрешения для ".$userbank->GetProperty('user', $_GET['id'])."', не имея на это прав.");
	echo '<div id="msg-red" >
	<i><img src="./images/warning.png" alt="Внимание" /></i>
	<b>Ошибка</b>
	<br />
	У Вас недостаточно прав для редактированиея разрешений другого админа.
</div>';
	PageDie();
}
...
<br />
<h3>Серверные разрешения админа</h3>
