	  	...
	  	<tr>
	  		...
	  		<div class="panel">
				...
				<tr>
			        ...
			        <td class="listtable_1" >Группа админов сервера</td>
			        <td class="listtable_1" >
				...
				<tr>
			        ...
			        <td class="listtable_1" >Серверные разрешения</td>
			        <td class="listtable_1" >
			    ...
			    <tr>
				    <td> </td>
				    <td> </td>
			        <td>{sb_button text="Поиск" onclick="search_admins();" class="ok" id="searchbtn" submit=false}</td>
			    </tr>
			   </table>
			   </div>
		  </td>
