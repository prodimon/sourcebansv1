...
{else}
	    ...
	    <table width="90%" style="border-collapse:collapse;" id="group.details" cellpadding="3">
			...
			<tr>
				<td valign="top"><div class="rowdesc">{help_icon title="Получить имена" message="Поставьте флажок, если Вы хотите получить имена игроков из их профиля Steam. (работает с  banned_users.cfg)"}Получить имена</div></td>
			    <td>
			    	<div align="left">
