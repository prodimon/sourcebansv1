...
{else}
	<div id="protests">
		...
		<table width="100%" cellpadding="0" cellspacing="0">
          ...
          <td class="toggler" style="border-bottom: solid 1px #ccc" height='16'><a href="./index.php?p=banlist&advSearch={$protest.authid}&advType=steamid" title="Показать бан">{$protest.name}</a></td>
