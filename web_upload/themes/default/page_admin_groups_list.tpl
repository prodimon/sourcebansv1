...
{else}
		            		...
		            		<td height="16" class="listtable_1">
								...
								{foreach from=$web_admins_list[$smarty.foreach.web_group.index] item="web_admin"}
									<tr>
										...
										<td width="20%" height="16" class="listtable_1"><a href="index.php?p=admin&c=admins&o=editgroup&id={$web_admin.aid}" title="Edit Groups">Редактировать</a></td>
										<td width="20%" height="16" class="listtable_1"><a href="index.php?p=admin&c=admins&o=editgroup&id={$web_admin.aid}&wg=" title="Remove From Group">Удалить</a></td>
										{/if}
									</tr>
								{/foreach}
								</table>
	...
	<tr>
		<td colspan="4">
			<table width="100%" cellpadding="0" cellspacing="0" class="front-module-header" class="listtable">
				<tr>
					<td align="left">Группы админов серверов</td>
      			...
      			<div class="opener"> 
					<table width="80%" cellspacing="0" cellpadding="0" class="listtable">
						...
						<tr align="left">
		            		...
		            		<td height="16" class="listtable_1">
								...
								{foreach from=$server_admins_list[$smarty.foreach.server_admin_group.index] item="server_admin"}
									<tr>
										...
										{if $permission_editadmin}
										<td width="20%" height="16" class="listtable_1"><a href="index.php?p=admin&c=admins&o=editgroup&id={$server_admin.aid}" title="Edit Groups">Редактировать</a></td>
										<td width="20%" height="16" class="listtable_1"><a href="index.php?p=admin&c=admins&o=editgroup&id={$server_admin.aid}&sg=" title="Remove From Group">Удалить</a></td>
										{/if}
									</tr>
								{/foreach}
								</table>
							...
							<tr align="left">
		            <td width="20%" height="16" class="listtable_1">Переопределения</td>
		            <td height="16" class="listtable_1">
									<table width="100%" cellspacing="0" cellpadding="0" class="listtable">
										<tr>
