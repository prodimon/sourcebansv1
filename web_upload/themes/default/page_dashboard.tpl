...
<div class="front-module" style="float:right">
	<table width="100%" cellpadding="1" class="listtable">
		<tr>
			<td colspan="3">
				<table width="100%" cellpadding="0" cellspacing="0" class="front-module-header">
					<tr>
						<td align="left">
							Последний заблокир. игрок
						</td>
						<td align="right">
							Всего заблокир.: {$total_blocked}
						</td>
					</tr>
				</table>
			</td>
		...
		<tr{if $dashboard_lognopopup} onclick="{$player.link_url}"{else} onclick="{$player.popup}"{/if} onmouseout="this.className='tbl_out'" onmouseover="this.className='tbl_hover'" style="cursor: pointer;" id="{$player.server}" title="Загрузка данных с сервера...">
      <td width="16" height="16" align="center" class="listtable_1"><img src="images/forbidden.png" width="16" height="16" alt="Заблокированный игрок" /></td>
...
<div class="front-module" style="float:left">
	<table width="100%" cellpadding="1" class="listtable">
		...
		<tr height="16">
			...
			<td class="listtable_top" align="center"><strong>Имя</strong></td>
